<template>
  <div>
    ...
    <ul class="answer-wrap">
      <li class="answer-list" v-for="answer in question.data">
        <div class="author">
          <img :src="answer.author.avatar_url" alt="" referrer="no-referrer">
          <div class="author-main">
            ...
            <p class="headline" v-html="answer.author.headline"></p>
          </div>
        </div>
        <p class="sub-info">
          <i class="vote">{{ answer.voteup_count }}</i>人赞同&nbsp;
          创建于{{ answer.created_time|formatTime }}
        </p>
...
<style lang="scss">
  ...
  .zh-lightbox-thumb,.thumbnail,img.lazy{
    display: block;
    max-width: vw(350);
    margin: vw(15) auto;
  }
